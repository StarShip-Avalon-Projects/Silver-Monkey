...
<span class="highlight-strvariable"><xsl:value-of select="text()" disable-output-escaping="yes" /></span>
</xsl:template>

<xsl:template match="lineid">
<span class="highlight-lineid"><xsl:value-of select="text()" disable-output-escaping="yes" /></span>
</xsl:template>

<xsl:template match="numvariable">
<span class="highlight-numvariable"><xsl:value-of select="text()" disable-output-escaping="yes" /></span>
</xsl:template>

<xsl:template match="dsstring">
<span class="highlight-dsstring"><xsl:value-of select="text()" disable-output-escaping="yes" /></span>
</xsl:template>
