...
namespace SilverMonkey.BugTraqConnect
{
    ...
    public class SubmitIssueForm : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.firstCustomFieldTextBox = new TextBox();
            this.secondCustomFieldTextBox = new TextBox();
            this.lblCustomField2 = new System.Windows.Forms.Label();
            this.openFileDialog1 = new System.Windows.Forms.OpenFileDialog();
            this.attachmentTextBox = new TextBox();
        ...
        private void submitButton_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                issue.ProductVersion = MonkeyCore.Utils.GetFileVersionInfo(Path.Combine(MonkeyCore.Paths.ApplicationPath, "Silver Monkey.exe")).ToString();
