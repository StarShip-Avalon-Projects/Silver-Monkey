...
namespace SilverMonkey.BugTraqConnect
{
    ...
    /// </summary>
    /// <remarks>
    /// This is useful to provide access to Mantis configuration like enumerations and any other
    /// configs that are not considered private. Using this class the client will not be able to
    /// retrieve sensitive information from the webservice, like passwords, database names, host
    /// names, ...etc.
    ///
    /// This class also provides the necessary caching to avoid unnecessary round trips to the
    /// server. Caching is feasible in this class due to the static nature of these configs.
    /// </remarks>
    public sealed class Config
    {
        ...
        /// </summary>
        /// <param name="session">
        /// Session to be used to retrieve the configs.
        /// </param>
        ...
        /// <summary>
        /// Returns a reference to the <see cref="Session"/> instance used to access MantisConnect webservice.
        /// </summary>
        ...
        /// </param>
        /// <param name="str">
        /// The output parameter to store the config variable in. This is a parameter rather than a
        /// return value to allow overloading of this method for different types.
        /// </param>
