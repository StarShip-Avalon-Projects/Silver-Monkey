...
#Region "Public Constructors"
    ...
    Public Overrides Sub Initialize(ParamArray args() As Object)
        ...
        Function()
            Return True
        End Function, "When the bot fails to banish a furre,")
        ...
        Function()
            Return True
        End Function, "When the bot successfully banishes a furre,")
        ...
        Function()
            Return True
        End Function, "When the bot sees the banish list,")
        '(0: ) When the bot fails to remove a furre from the banish list,
        Add(TriggerCategory.Cause, 55,
        Function()
            Return True
        End Function, "When the bot fails to remove a furre from the banish list,")
        ...
        Function()
            Return True
        End Function, "When the bot successfully removes a furre from the banish list,")
        ...
        Function()
            Return True
        End Function, "When the bot fails to empty the banish list,")

        '(0: ) When the bot successfully clears the banish list,
        Add(TriggerCategory.Cause, 60,
        Function()
            Return True
        End Function, "When the bot successfully clears the banish list,")

        '(0: ) When the bot successfully temp banishes a furee,
        Add(TriggerCategory.Cause, 61,
        Function()
            Return True
        End Function, "When the bot successfully temp banishes a furre,")
...
#Region "Public Methods"
    ...
    Function AndBanishFurreNamed(reader As TriggerReader) As Boolean
        ...
        Return Furre.ToFurcadiaShortName = ParentBotSession.BanishName.ToFurcadiaShortName
    ...
    Function FurreNamedIsNotBanished(reader As TriggerReader) As Boolean
        Dim banishlist As List(Of String) = ParentBotSession.BanishList
