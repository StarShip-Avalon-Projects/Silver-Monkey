...
#Region "Public Constructors"
    ...
    Public Overrides Sub Add(trigger As Trigger, handler As TriggerHandler, Optional description As String = Nothing)
        Add(trigger.Category, trigger.Id, handler, description)
    End Sub
...
#Region "Public Methods"
    ...
    Public Function FurreNamedIsNotBanished(reader As TriggerReader) As Boolean
        Dim banishlist = ParentBotSession.BanishList
    ...
    Public Function UnBanishFurreNamed(reader As TriggerReader) As Boolean
        ...
        Dim Furre As String = reader.ReadString
        Return MyBase.SendServer("banish-off " + Furre)
    ...
    Public Function UnBanishTrigFurre(reader As TriggerReader) As Boolean
        ...
        Return MyBase.SendServer("banish-off " + Player.Name)
