...
#Region "Public Methods"
        ...
        '    Dim Dir = reader.ReadVariable(True)
        '    Dim name = reader.ReadString
        '    Dim tPlayer As Furre = DreamInfo.Furres.GerFurreByName(name)
        '    Dim direction As Double = 0
        ...
        Public Function FurreNamedMoveFrom(reader As TriggerReader) As Boolean
            ...
            Dim tPlayer = DreamInfo.Furres.GerFurreByName(reader.ReadString)
        ...
        Public Function FurreNamedMoveInto(reader As TriggerReader) As Boolean
            ...
            Dim tPlayer As Furre = DreamInfo.Furres.GerFurreByName(reader.ReadString)
            Dim X = reader.ReadNumber()
            Dim Y = reader.ReadNumber()
        ...
        '    Dim name = reader.ReadString
        '    Dim tPlayer = DreamInfo.Furres.GerFurreByName(name)
        '    Dim Dir = reader.ReadNumber()
        '    Dim Direction = 0
        ...
        Public Function FurreNamedSitting(reader As TriggerReader) As Boolean
            Return 0 = DreamInfo.Furres.GerFurreByName(reader.ReadString).Pose
        End Function
        ...
        Public Function FurreNamedSpecies(reader As TriggerReader) As Boolean
            ...
            Dim name = reader.ReadString
            Dim TargetFurre = DreamInfo.Furres.GerFurreByName(name)
        ...
        Public Function FurreNamedStanding(reader As TriggerReader) As Boolean
            ...
            Dim TargetFurre = DreamInfo.Furres.GerFurreByName(reader.ReadString)
        ...
        Public Function MoveBot(reader As TriggerReader) As Boolean
            ...
            Dim Direction = reader.ReadNumber()
        ...
        Public Function NotDescContainsFurreNamed(reader As TriggerReader) As Boolean
            ...
            Dim Target As Furre = DreamInfo.Furres.GerFurreByName(reader.ReadString())
