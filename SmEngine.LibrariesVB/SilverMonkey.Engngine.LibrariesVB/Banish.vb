...
#Region "Public Constructors"
    ...
    Public Overrides Sub Initialize(ParamArray args() As Object)
        ...
        Add(TriggerCategory.Condition, 50, AddressOf TrigFurreIsNotBanished, "(1:50) and the triggering furre is not on the banish list,")

        '(1:51) and the triggering furre is on the banish list,
        Add(TriggerCategory.Condition, 51, AddressOf TrigFurreIsBanished, "(1:51) and the triggering furre is on the banish list,")
        '(1:52) and the furre named {...} is not on the banish list,
        Add(TriggerCategory.Condition, 52, AddressOf FurreNamedIsNotBanished, "(1:52) and the furre named {...} is not on the banish list,")
        '(1:53) and the furre named {...} is on the banish list,
        Add(TriggerCategory.Condition, 53, AddressOf FurreNamedIsBanished, "(1:53) and the furre named {...} is on the banish list,")
