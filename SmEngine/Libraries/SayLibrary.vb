        ...
        Private Sub OnServerChannel(InstructionObject As ChannelObject, Args As ParseServerArgs) Handles FurcadiaSession.ProcessServerChannelData
            ...
            Select Case InstructionObject.Channel
                Case "shout"
                    ...
                    FurcadiaSession.MSpage.Execute(8, 9, 10)
                Case "say"
                    ...
                    FurcadiaSession.MSpage.Execute(5, 6, 7, 18, 19, 20)
                ...
                Case "whisper"
                    ...
                    ' with {...} in it
                    FurcadiaSession.MSpage.Execute(15, 16, 17)
                ...
                Case "emote"
                    ...
                    FurcadiaSession.MSpage.Execute(11, 12, 13, 18, 19, 20)
                Case "emit"
                    ' (0:21) When someone emits something
                    ' (0:22) When someone emits {...}
                    ' (0:23) When someone emits something with {...} in it

                    FurcadiaSession.MSpage.Execute(21, 22, 23)
                Case "@emit"
                    ' (0:21) When someone emits something
                    ' (0:22) When someone emits {...}
                    ' (0:23) When someone emits something with {...} in it
                ...
                Case "query"
                    ...
                    Select Case QueryComand
                        Case "summon"
                            ...
                            FurcadiaSession.MSpage.Execute(34, 35)

                        Case "join"
                            ''SUMMON

                            FurcadiaSession.MSpage.Execute(32, 33)

                        Case "follow"
                            ''LEAD

                            FurcadiaSession.MSpage.Execute(36, 37)

                        Case "lead"
                            ''FOLLOW

                            FurcadiaSession.MSpage.Execute(38, 39)

                        Case "cuddle"

                            FurcadiaSession.MSpage.Execute(40, 41)
