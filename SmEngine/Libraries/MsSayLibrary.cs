    ...
    public sealed class MsSayLibrary : MonkeySpeakLibrary
    {
        ...
        public override void Initialize(params object[] args)
        {
            ...
            Add(TriggerCategory.Cause, 10,
                r => MsgContains(r),
                "When someone shouts something with {..} in it,");
            ...
            Add(TriggerCategory.Cause, 13,
                r => MsgContains(r),
                "When someone emotes something with {..} in it,");
            ...
            Add(TriggerCategory.Cause, 17,
                r => MsgContains(r),
                "When someone whispers something with {..} in it,");
            ...
            Add(TriggerCategory.Cause, 19,
                r => MsgIs(r),
                "When someone says or emotes {..},");

            // (0:13) When some one emotes something with {..} in it
            Add(TriggerCategory.Cause, 20,
                r => MsgContains(r),
                "When someone says or emotes something with {..} in it,");
            ...
            Add(TriggerCategory.Cause, 28,
                r => EnterView(r),
                "When someone enters the bots view, ");
            ...
            Add(TriggerCategory.Cause, 30,
                r => LeaveView(r),
                "When someone leaves the bots view, ");
            ...
            Add(TriggerCategory.Cause, 34, r =>
            {
                ...
                ReadTriggeringFurreParams(r);
                return !IsConnectedCharacter(Player);
            }, "When someone requests to join the bot,");
            ...
            Add(TriggerCategory.Cause, 38, r =>
            {
                ...
                ReadTriggeringFurreParams(r);
                return !IsConnectedCharacter(Player);
            }, "When someone requests to lead the bot,");
        ...
        /// true on success
        /// </returns>
        public bool LeaveView(TriggerReader reader)
        {
            ReadTriggeringFurreParams(reader);
            return Player.Visible == Player.WasVisible;
        }
        ...
        /// message to send
        /// </param>
        public bool SendEmit(string msg)
        {
        ...
        /// message to send
        /// </param>
        public bool SendEmitLoud(string msg)
        {
            if (!string.IsNullOrWhiteSpace(msg))
            {
        ...
        /// message to send
        /// </param>
        public bool SendEmote(string msg)
        {
            if (!string.IsNullOrWhiteSpace(msg))
            {
        ...
        /// Message to send
        /// </param>
        public bool SendOffLineWhisper(string name, string msg)
        {
            if (!string.IsNullOrWhiteSpace(msg))
            {
        ...
        /// message to send
        /// </param>
        public bool SendSay(string msg)
        {
            if (!string.IsNullOrWhiteSpace(msg))
            {
                return SendServer(msg);
        ...
        /// Message to send
        /// </param>
        public bool SndShout(string msg)
        {
            if (!string.IsNullOrWhiteSpace(msg))
            {
                return SendServer($"-{ msg}");
        ...
        /// Message to send
        /// </param>
        public bool SndWhisper(string name, string msg)
        {
            if (!string.IsNullOrWhiteSpace(msg))
            {
                return SendServer($"/%{name.ToFurcadiaShortName()} {msg}");
        ...
        /// true on success
        /// </returns>
        public bool StandAloneMode(TriggerReader reader)
        {
        ...
        /// true on success
        /// </returns>
        protected bool MsgIsNot(TriggerReader reader)
        {
            return !base.MsgIs(reader);
        }
        ...
        /// true on success
        /// </returns>
        protected bool MsgNotContain(TriggerReader reader)
        {
        ...
        /// true on success
        /// </returns>
        protected bool NameIsNot(TriggerReader reader)
        {
            return !base.NameIs(reader);
        }
    }
