...
namespace Futureware.MantisSubmit
{
    ...
    public class SubmitIssueForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tabPage2.Size = new System.Drawing.Size(1142, 317);
            ...
            this.tabPage3.Size = new System.Drawing.Size(1142, 317);
            ...
            this.repoStepsTextBox.Size = new System.Drawing.Size(1136, 311);
            ...
            this.notedTextBox.Size = new System.Drawing.Size(1142, 317);
        ...
        public void WalkNode(List<Project> projects, ref TreeNode Tn, ref TreeNode FounNode, string NameToFind)
        {
        ...
        private void submitButton_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                toolStripStatusLabel1.Text = "Checking if issue already reported...";

                // Check if issue was previously logged in Mantis.
                int issueId = session.Request.IssueGetIdFromSummary(summaryTextBox.Text);
                if (issueId > 0)
                {
                    toolStripStatusLabel1.Text = string.Format("'{0}' already reported in issue {1}", summaryTextBox.Text, issueId);
                    return;
                }
                ...
                toolStripStatusLabel1.Text = "Submitting issue...";

                int newIssueId = session.Request.IssueAdd(issue);

                toolStripStatusLabel1.Text = String.Format("Submitting attachment to issue {0}...", newIssueId);
                ...
                toolStripStatusLabel1.Text = $"Issued added as {newIssueId}.";
