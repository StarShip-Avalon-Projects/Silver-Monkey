...
#Region "Public Properties"
        ...
        ''' </summary>
        ''' <returns> true if NameList has Changed</returns>
...
#Region "Public Methods"
        ...
        ''' </summary>
        ''' <param name="Furre"> Furre Name</param>
        ...
        ''' </summary>
        ''' <param name="ListFile">Text file containing the names (one name per line)</param>
        ...
        ''' </summary>
        ''' <param name="ListFile">File Name</param>
        ...
        ''' </summary>
        ''' <returns>String array of names in Furcadia Short name format</returns>
