...
#Region "Private Fields"
    ...
    Private WithEvents OnlineFurreList As New PounceList
...
#Region "Public Constructors"
    ...
    Public Sub New()
        ...
        OnlineFurreList = New PounceList
...
#Region "Public Methods"
    ...
    Function FurreNamedNotOnline(reader As TriggerReader) As Boolean
        Try
            ...
            For Each OnLineFurre As KeyValuePair(Of String, pFurre) In OnlineFurreList
