...
#Region "Public Methods"
        ...
        Function TriggeringFurreFacingNE(reader As TriggerReader) As Boolean
            Try
                ...
                Select Case FurcadiaSession.Player.Color.dir
                    Case 3
                        Return True
                End Select
                Return False
        ...
        Function TriggeringFurreLaying(reader As TriggerReader) As Boolean
            Try
                ...
                Select Case FurcadiaSession.Player.Color.pose
                    Case 4
                        Return True
                End Select
                Return False
        ...
        Function TriggeringFurreSitting(reader As TriggerReader) As Boolean
            Try
                Dim tPlayer As FURRE = FurcadiaSession.Player
                Select Case FurcadiaSession.Player.Color.Species.pose
                    Case 0
                        Return True
                End Select
                Return False
