...
Public Class Description
    ...
    Public Sub New()
        ...
        Add(Monkeyspeak.TriggerCategory.Cause, 600,
        Function()
            Return True
        End Function, "(0:600) When the bot reads a description.")

        '(1:600) and triggering furre's description contains {...}
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 600), AddressOf DescContains,
"(1:600) and triggering furre's description contains {...}")

        '(1:601) and triggering furre's description does not contain {...}
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 601), AddressOf NotDescContains,
"(1:601) and triggering furre's description does not contain {...}")

        '(1:602) and the furre named {...} description contains {...}
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 602), AddressOf DescContainsFurreNamed,
"(1:602) and the furre named {...} description contains {...}if they are in the dream,")
        ...
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 603), AddressOf NotDescContainsFurreNamed,
"(1:603) and the furre named {...} description does not contain {...} if they are in the dream")

        '(1:604) and the triggering furre is male,
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 604), AddressOf TriggeringFurreMale,
"(1:604) and the triggering furre is male,")

        '(1:605) and the triggering furre is female,
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 605), AddressOf TriggeringFurreFemale,
"(1:605) and the triggering furre is female,")

        '(1:606) and the triggering furre is unspecified,
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 606), AddressOf TriggeringFurreUnspecified,
"(1:606) and the triggering furre is unspecified,")

        '(1:608) and the furre named {...}'s is male,
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 608), AddressOf FurreNamedMale,
"(1:608) and the furre named {...}'s is male if they are in the dream,")
        '(1:609) and the furre named {...}'s is female,
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 609), AddressOf FurreNamedFemale,
"(1:609) and the furre named {...}'s is female if they are in the dream,")
        '(1:609) and the furre named {...}'s is female,
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 610), AddressOf FurreNamedUnSpecified,
"(1:610) and the furre Named {...}'s is unspecified if they are in the dream,")
        ...
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 612), AddressOf TriggeringFurreSpecies,
"(1:612) and the trigger furre is Species # (please see http://www.furcadia.com/dsparams/ for info)")

        '(1:613) and the furre named {...} is Species # (please see http://www.furcadia.com/dsparams/ for info)
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 613), AddressOf FurreNamedSpecies,
"(1:613) and the furre named {...} is Species # if they are in the dream (please see http://www.furcadia.com/dsparams/ for info)")
        ...
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 614), AddressOf TriggeringFurreWings,
"(1:614) and the triggering furre has wings of type #, (please see http://www.furcadia.com/dsparams/ for info)")
        ...
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 615), AddressOf TriggeringFurreNoWings,
"(1:615) and the triggering furre doesn't wings of type #, (please see http://www.furcadia.com/dsparams/ for info)")
        ...
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 616), AddressOf FurreNamedWings,
"(1:616) and the furre named {...} has wings of type #, (please see http://www.furcadia.com/dsparams/ for info)")
        ...
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 617), AddressOf FurreNamedNoWings,
"(1:617) and the furre named {...}  doesn't wings of type #, (please see http://www.furcadia.com/dsparams/ for info)")
        ...
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 618), AddressOf TriggeringFurreStanding,
"(1:618) and the triggering furre is standing.")

        '(1:619) and the triggering furre is sitting.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 619), AddressOf TriggeringFurreSitting,
"(1:619) and the triggering furre is sitting.")

        '(1:620) and the triggering furre is laying.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 620), AddressOf TriggeringFurreLaying,
"(1:620) and the triggering furre is laying.")

        '(1:621) and the triggering furre is facing NE,
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 621), AddressOf TriggeringFurreFacingNE,
"(1:621) and the triggering furre is facing NE,")

        '(1:622) and the triggering furre is facing NW,
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 622), AddressOf TriggeringFurreFacingNW,
"(1:622) and the triggering furre is facing NW,")

        '(1:623) and the triggering furre is facing SE,
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 623), AddressOf TriggeringFurreFacingSE,
"(1:623) and the triggering furre is facing SE,")

        '(1:624) and the triggering furre is facing SW,
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 624), AddressOf TriggeringFurreFacingSW,
"(1:624) and the triggering furre is facing SW,")

        '(1:625) and the furre named {...} is standing.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 625), AddressOf FurreNamedStanding,
"(1:625) and the furre named {...} is standing.")

        '(1:626) and the furre named {...} is sitting.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 626), AddressOf FurreNamedSitting,
"(1:626) and the furre named {...} is sitting.")

        '(1:627) and the furre named {...} is laying.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 627), AddressOf FurreNamedLaying,
"(1:627) and the furre named {...} is laying.")

        '(1:628) and the furre named {...} is facing NE,
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 628), AddressOf FurreNamedFacingNE,
"(1:628) and the furre named {...} is facing NE,")

        '(1:629) and the furre named {...} is facing NW,
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 629), AddressOf FurreNamedFacingNW,
"(1:629) and the furre named {...} is facing NW,")

        '(1:630) and the furre named {...} is facing SE,
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 630), AddressOf FurreNamedFacingSE,
"(1:630) and the furre named {...} is facing SE,")

        '(1:631) and the furre named {...} is facing SW,
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 631), AddressOf FurreNamedFacingSW,
"(1:631) and the furre named {...} is facing SW,")

        '(5:600) set variable %Variable to the Triggering furre's description.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 600), AddressOf TriggeringFurreDescVar,
"(5:600) set variable %Variable to the Triggering furre's description.")

        '(5:601) set variable %Variable to the triggering furre's gender.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 601), AddressOf TriggeringFurreGenderVar,
"(5:601) set variable %Variable to the triggering furre's gender.")

        '(5:602) set variable %Variable to the triggering furre's species.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 602), AddressOf TriggeringFurreSpeciesVar,
"(5:602) set variable %Variable to the triggering furre's species.")

        '(5:604) set variable %Variable to the triggering furre's colors.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 604), AddressOf TriggeringFurreColorsVar,
"(5:604) set variable %Variable to the triggering furre's colors.")

        '(5:605) set variable %Variable to the furre named {...}'s gender if they are in the dream.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 605), AddressOf FurreNamedGenderVar,
"(5:605) set variable %Variable to the furre named {...}'s gender if they are in the dream.")

        '(5:606) set variable %Variable to the furre named {...}'s species, if they are in the dream.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 606), AddressOf FurreNamedSpeciesVar,
"(5:606) set variable %Variable to the furre named {...}'s species, if they are in the dream.")

        '(5:607) set variable %Variable to the furred named {...}'s description, if they are in the dream.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 607), AddressOf FurreNamedDescVar,
"(5:607) set variable %Variable to the furred named {...}'s description, if they are in the dream.")

        '(5:608) set variable %Variable to the furre named {...}'s colors, if they are in the dream.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 608), AddressOf FurreNamedColorsVar,
"(5:608) set variable %Variable to the furre named {...}'s colors, if they are in the dream.")

        '(5:609) set %Variable to the wings type the triggering furre is wearing.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 609), AddressOf TriggeringFurreWingsVar,
"(5:609) set %Variable to the wings type the triggering furre is wearing.")

        '(5:610) set %Variable to the wings type the furre named {...} is wearing.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 610), AddressOf FurreNamedWingsVar,
"(5:610) set %Variable to the wings type the furre named {...} is wearing.")
    ...
    Function DescContains(reader As Monkeyspeak.TriggerReader) As Boolean
        ...
        Catch ex As Exception
            ...
            Dim tCat As String = reader.TriggerCategory.ToString.ToString.ToString
    ...
    Function FurreNamedGenderVar(reader As Monkeyspeak.TriggerReader) As Boolean
        Try
            Dim Var As Monkeyspeak.Variable = reader.ReadVariable(True)
            Dim name As String = reader.ReadString
            Dim Target As FURRE = callbk.NametoFurre(name, False)
    ...
    Function FurreNamedSpeciesVar(reader As Monkeyspeak.TriggerReader) As Boolean
        Try
            Dim Var As Monkeyspeak.Variable = reader.ReadVariable(True)
            Dim name As String = reader.ReadString
            Dim Target As FURRE = callbk.NametoFurre(name, False)
    ...
    Function FurreNamedDescVar(reader As Monkeyspeak.TriggerReader) As Boolean
        Try
            Dim Var As Monkeyspeak.Variable = reader.ReadVariable(True)
            Dim name As String = reader.ReadString
            Dim Target As FURRE = callbk.NametoFurre(name, False)
    ...
    Function FurreNamedColorsVar(reader As Monkeyspeak.TriggerReader) As Boolean
        Try
    ...
    End Function
    '(5:610) set %Variable to the wings type the furre named {...} is wearing.
    Function FurreNamedWingsVar(reader As Monkeyspeak.TriggerReader) As Boolean
        Try
            Dim Var As Monkeyspeak.Variable = reader.ReadVariable(True)
            Dim name As String = reader.ReadString
            Dim Target As FURRE = callbk.NametoFurre(name, False)
