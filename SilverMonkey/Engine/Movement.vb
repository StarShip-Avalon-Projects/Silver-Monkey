...
Public Class Movement
    ...
    Public Sub New()
        ...
        Add(Monkeyspeak.TriggerCategory.Cause, 602, AddressOf MoveInto, "(0:602) when a furre moves into (x,y),")

        '(1:900) and the triggering furre moved into/is standing at (x,y),
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 632), AddressOf MoveInto, "(1:632) and the triggering furre moved into/is standing at (x,y)")

        '(1:633) and the furre named {...} moved into/is standing at (x,y),
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 633), AddressOf FurreNamedMoveInto, "(1:633) and the furre named {...} moved into/is standing at (x,y),")

        '(1:634) and the triggering furre moved from (x,y),
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 634), AddressOf MoveFrom, "(1:634) and the triggering furre moved from (x,y),")

        '(1:635) and the furre named {...} moved from (x,y),
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 635), AddressOf FurreNamedMoveFrom, "(1:635) and the furre named {...} moved from (x,y),")
        ...
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 636), AddressOf MoveIntoDirection, "(1:636) and the triggering furre successfully moved in direction # (seven = North-West, nine = North-East, three = South-East, one = South=West)")
        ...
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 637), AddressOf FurreNamedMoveIntoDirection, "(1:637) and the furre named {...}, successfully moved in direction # (seven = North-West, nine = North-East, three = South-East, one = South=West)")

        '(1:638) and the triggering furre tried to move but stood still.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 638), AddressOf StoodStill, "(1:638) and the triggering furre tried to move but stood still.")

        '(1:639) and the furre named {...} tried to move but stood still.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Condition, 639), AddressOf FurreNamedMoveIntoDirection, "(1:639) and the furre named {...} tried to move but stood still..")

        '(5:613) move the bot in direction # one space. (seven = North-West, nine = North-East, three = South-East, one = South=West)
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 613), AddressOf MoveBot, "(5:613) move the bot in direction # one space. (seven = North-West, nine = North-East, three = South-East, one = South=West)")

        '(5:614) turn the bot clock-wise one space.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 614), AddressOf TurnCW, "(5:614) turn the bot clock-wise one space.")

        '(5:615) turn the bot counter-clockwise one space.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 615), AddressOf TurnCCW, "(5:615) turn the bot counter-clockwise one space.")

        '(5:616) set variable %Variable to the X coordinate where the triggering furre moved into/is at.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 616), AddressOf SetCordX, "(5:616) set variable %Variable to the X coordinate where the triggering furre moved into/is at.")

        '(5:617) set variable %Variable to the Y coordinate where the triggering furre moved into/is at.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 617), AddressOf SetCordY, "(5:617) set variable %Variable to the Y coordinate where the triggering furre moved into/is at.")

        '(5:618) set variable %Variable to the X coordinate where the furre named {...} moved into/is at.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 618), AddressOf FurreNamedSetCordX, "(5:618) set variable %Variable to the X coordinate where the furre named {...} moved into/is at.")

        '(5:619) set variable %Variable to the Y coordinate where the furre named {...} moved into/is at.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 619), AddressOf FurreNamedSetCordY, "(5:619) set variable %Variable to the Y coordinate where the furre named {...} moved into/is at.")
        ...
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 620), AddressOf FaceDirectionNumber, "(5:620) set %Variable to the direction number the triggering furre is facing/ moved in. (seven = North-West, nine = North-East, three = South-East, one = South=West)")
        ...
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 621), AddressOf FurreNamedFaceDirectionNumber, "(5:621) set %Variable to the direction number the furre names {...}, is facing/ moved in. (seven = North-West, nine = North-East, three = South-East, one = South=West)")

        '(5:622) make the bot sit down.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 622), AddressOf BotSit, "(5:622) make the bot sit down.")

        '(5:623) make the bot lay down.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 623), AddressOf BotLie, "(5:623) make the bot lay down.")

        '(5:624) make the bot stand up.
        Add(New Monkeyspeak.Trigger(Monkeyspeak.TriggerCategory.Effect, 624), AddressOf BotStand, "(5:624) make the bot stand up.")
