...
#Region "Public Constructors"
        ...
        "(0:15) When someone whispers something,")
            ...
            Add(New Trigger(TriggerCategory.Condition, 16),
                Function()
                    Return Not MainMsEngine.IsBotControler(MyMonkeySpeakEngine.MSpage.GetVariable(MS_Name).Value.ToString)
...
#Region "Public Methods"
        ...
        Public Function EnterMyDreamNamed(reader As Monkeyspeak.TriggerReader) As Boolean
            Try
                ...
                Dim msg As Variable = MyMonkeySpeakEngine.MSpage.GetVariable("MyDreamNAME")
        ...
        Function NameIsNot(reader As TriggerReader) As Boolean
            Try
                Dim tname As String = MyMonkeySpeakEngine.MSpage.GetVariable(MS_Name).Value.ToString
                Dim TmpName As String = reader.ReadString()
                'add Machine Name parser
